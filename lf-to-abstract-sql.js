var OMeta = require("ometa-js/lib/ometajs/core"), SBVRCompilerLibs = require("./sbvr-compiler-libs").SBVRCompilerLibs, _ = require("lodash"), LF2AbstractSQL = exports.LF2AbstractSQL = SBVRCompilerLibs._extend({
    Number: function() {
    ...
    LinkTable: function(actualFactType) {
        ...
        _.each(binds, function(bind, i) {
            ...
            if (!$elf.GetTable(baseIdentifierName).primitive) {
                ...
                _.each($elf.ResolveSynonym(baseIdentifierName).split("-"), function(partName) {
